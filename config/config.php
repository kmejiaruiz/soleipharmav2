...
if (file_exists($_appJsonPath)) {
    ...
    if (!defined('COMPANY_NAME'))       define('COMPANY_NAME',       'Farmacia Solei');
    if (!defined('BRANCH'))             define('BRANCH',             '');
    if (!defined('LOW_STOCK_THRESHOLD')) define('LOW_STOCK_THRESHOLD', 9);
    if (!defined('APP_BASE'))           define('APP_BASE', '/' . basename(dirname(__DIR__)));
