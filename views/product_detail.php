        ...
        <div class="md:w-1/2 p-6">
            ...
            <p class="mt-4 text-xl font-semibold text-gray-800">
                ...
                <?php if ($product['tax_percent'] > 0): ?>
                    <span class="text-sm text-gray-500">(+ <?= number_format($product['tax_percent'], 2) ?>% IVA)</span>
                <?php endif; ?>
            </p>
            <p class="mt-2 text-gray-600">Stock disponible: <?= (int) $product['stock'] ?></p>
            ...
            ?>
            <?php if ($disabled): ?>
                <div class="bg-red-200 text-red-800 p-2 rounded mt-4"><?= htmlspecialchars($msg) ?></div>
            <?php endif; ?>
